...
[
	...
	[localize "str_a3_cfgweapons_arifle_katiba_c_f0", "arifle_Katiba_C_F", 200],
	[localize "str_a3_cfgweapons_arifle_katiba_f0", "arifle_Katiba_F", 250],
	[localize "str_a3_cfgweapons_arifle_katiba_gl_f0", "arifle_Katiba_GL_F", 300],
	...
	["MAR-10 Rifle [DLC]", "srifle_DMR_02_F", 3000],
	["MAR-10 Rifle (Camo) [DLC]", "srifle_DMR_02_camo_F", 3000],
	["MAR-10 Rifle (Sand) [DLC]", "srifle_DMR_02_sniper_F", 3000],
	["Cyrus Rifle [DLC]", "srifle_DMR_05_blk_F", 3000],
	["Cyrus Rifle (Hex) [DLC]", "srifle_DMR_05_hex_F", 3000],
	["Cyrus Rifle (Tan) [DLC]", "srifle_DMR_05_tan_f", 3000],

	// Sniper Rifles
	[localize "str_a3_cfgweapons_srifle_lrr0", "srifle_LRR_SOS_F", 4000],
	[localize "str_a3_cfgweapons_srifle_lrr_camo_f0", "srifle_LRR_camo_SOS_F", 4000],
	[localize "str_a3_cfgweapons_srifle_gm60", "srifle_GM6_SOS_F", 4000],
	[localize "str_a3_cfgweapons_srifle_gm6_camo_f0", "srifle_GM6_camo_SOS_F", 4000],
...
[
	...
	["SPMG MMG (Sand) [DLC]", "MMG_02_sand_F", 3000],
	["SPMG MMG (MTP) [DLC]", "MMG_02_camo_F", 3000],
	["SPMG MMG (Black) [DLC]", "MMG_02_black_F", 3000]
];
...
[
	...
	[localize "str_cfgweapons_launch_mprl_short_f0" + " (" + localize "STR_WL_Skin_Tan" + ")", "launch_Titan_short_F", 1000],
	[localize "str_cfgweapons_launch_mprl_short_f0" + " (" + localize "STR_WL_Skin_Brn" + ")", "launch_O_Titan_short_F", 1000],
	[localize "str_cfgweapons_launch_mprl_short_f0" + " (" + localize "STR_WL_Skin_Oli" + ")", "launch_I_Titan_short_F", 1000],
	[localize "str_a3_cfgweapons_launch_mprl0" + " (" + localize "STR_WL_Skin_Desert" + ")", "launch_Titan_F", 1000],
	[localize "str_a3_cfgweapons_launch_mprl0" + " (" + localize "STR_WL_Skin_Hex" + ")", "launch_O_Titan_F", 1000],
	[localize "str_a3_cfgweapons_launch_mprl0" + " (" + localize "STR_WL_Skin_Dgtl" + ")", "launch_I_Titan_F", 1000]
];
...
[
	...
	[localize "str_a3_cfgvehicles_hmg_01_a_base0", "B_HMG_01_A_F", 100000], // "A" = Autonomous = Overpowered
	[localize "str_a3_cfgvehicles_hmg_01_a_base0", "O_HMG_01_A_F", 100000],
	[localize "str_a3_cfgvehicles_hmg_01_a_base0", "I_HMG_01_A_F", 100000],
	...
	[localize "str_a3_cfgvehicles_gmg_01_a_base0", "B_GMG_01_A_F", 100000],
	[localize "str_a3_cfgvehicles_gmg_01_a_base0", "O_GMG_01_A_F", 100000],
	[localize "str_a3_cfgvehicles_gmg_01_a_base0", "I_GMG_01_A_F", 100000],
	...
	[localize "str_a3_cfgvehicles_mortar_01_base0", "B_Mortar_01_F", 25000],
	[localize "str_a3_cfgvehicles_mortar_01_base0", "O_Mortar_01_F", 25000],
	[localize "str_a3_cfgvehicles_mortar_01_base0", "I_Mortar_01_F", 25000]
];
...
[
	...
	[localize "str_a3_cfgmagazines_7rnd_408_mag0", "7Rnd_408_Mag", 100],
	[localize "str_a3_cfgmagazines_5rnd_127x108_mag0", "5Rnd_127x108_Mag", 100],
	[localize "str_a3_cfgmagazines_5rnd_127x108_apds_mag0", "5Rnd_127x108_APDS_Mag", 100],
	...
	[localize "str_a3_cfgmagazines_titan_at0", "Titan_AT", 500],          // Direct damage: high      | Splash damage: low    | Guidance: mouse, laser, ground vehicles
	[localize "str_a3_cfgmagazines_titan_ap0", "Titan_AP", 350],          // Direct damage: low       | Splash damage: high   | Guidance: mouse, laser
	[localize "str_a3_cfgmagazines_titan_aa0", "Titan_AA", 500],          // Direct damage: low       | Splash damage: medium | Guidance: aircraft
...
[
	[localize "str_a3_cfgweapons_muzzle_snds_l0", "muzzle_snds_L", 100, "item"],
	[localize "str_a3_cfgweapons_muzzle_snds_acp0", "muzzle_snds_acp", 100, "item"],
	[localize "str_a3_cfgweapons_muzzle_snds_m0", "muzzle_snds_M", 200, "item"],
	[localize "str_a3_cfgweapons_muzzle_snds_h0", "muzzle_snds_H", 200, "item"],
	[localize "str_a3_cfgweapons_muzzle_snds_h_mg0", "muzzle_snds_H_MG", 200, "item"],
	[localize "str_a3_cfgweapons_muzzle_snds_b0", "muzzle_snds_B", 250, "item"],
	["Suppressor .338 [DLC]", "muzzle_snds_338_black", 300, "item"],
	["Suppressor .338 (Green) [DLC]", "muzzle_snds_338_green", 300, "item"],
	["Suppressor .338 (Sand) [DLC]", "muzzle_snds_338_sand", 300, "item"],
	["Suppressor 9.3mm [DLC]", "muzzle_snds_93mmg", 300, "item"],
	["Suppressor 9.3mm (Tan) [DLC]", "muzzle_snds_93mmg_tan", 300, "item"],
	...
	[localize "str_a3_cfgweapons_optic_arco0", "optic_Arco", 225, "item"],
	[localize "str_a3_cfgweapons_optic_hamr0", "optic_Hamr", 250, "item"],
	[localize "str_a3_cfgweapons_optic_sos0", "optic_SOS", 300, "item"],
	[localize "str_a3_cfgweapons_acc_dms0", "optic_DMS", 375, "item"],
	["AMS [DLC]", "optic_AMS", 300, "item"],
	["AMS (Khaki) [DLC]", "optic_AMS_khk", 300, "item"],
	["AMS (Sand) [DLC]", "optic_AMS_snd", 300, "item"],
	...
	[localize "str_a3_cfgweapons_optic_lrps0", "optic_LRPS", 500, "item"],
	[localize "str_a3_cfgweapons_optic_nvs0", "optic_NVS", 500, "item"],
	[localize "str_a3_cfgweapons_optic_tws0", "optic_tws", 15000, "item"],
	[localize "str_a3_cfgweapons_optic_tws_mg0", "optic_tws_mg", 18000, "item"],
	[localize "str_a3_cfgweapons_optic_nightstalker0", "optic_Nightstalker", 25000, "item"]
];
...
[
	...
	["Full Ghillie (Semi-Arid) (NATO)", "U_B_FullGhillie_sard", 1500, "uni"],
	["Full Ghillie (Semi-Arid) (CSAT)", "U_O_FullGhillie_sard", 1500, "uni"],
	["Full Ghillie (Semi-Arid) (AAF)", "U_I_FullGhillie_sard", 1500, "uni"],
...
[
	...
	["Mine & Beacon Detector", "MineDetector", 250, "item"],
	["NV Goggles", "NVGoggles", 100, "nvg"],
	["Diving Goggles", "G_Diving", 100, "gogg"],
	["Binoculars", "Binocular", 50, "binoc"],
	["Rangefinder", "Rangefinder", 500, "binoc"],
	["Laser Designator", "Laserdesignator", 2000, "binoc"],
...
[
	...
	["HBarrier (1 block)", "Land_HBarrier_1_F", 2000, "object"],
	["HBarrier (3 blocks)", "Land_HBarrier_3_F", 2000, "object"],
	["HBarrier (5 blocks)", "Land_HBarrier_5_F", 2000, "object"],
	["HBarrier Big", "Land_HBarrierBig_F", 2000, "object"],
	["HBarrier Wall (4 blocks)", "Land_HBarrierWall4_F", 2000, "object"],
	["HBarrier Wall (6 blocks)", "Land_HBarrierWall6_F", 2000, "object"],
	["HBarrier Watchtower", "Land_HBarrierTower_F", 2000, "object"],
	["Concrete Wall", "Land_CncWall1_F", 2000, "object"],
	["Concrete Military Wall", "Land_Mil_ConcreteWall_F", 2000, "object"],
	["Concrete Wall (Long)", "Land_CncWall4_F", 2000, "object"],
	["Military Wall (Big)", "Land_Mil_WallBig_4m_F", 2000, "object"],
	//["Shoot House Wall", "Land_Shoot_House_Wall_F", 180, "object"],
	["Canal Wall (Small)", "Land_Canal_WallSmall_10m_F", 2000, "object"],
	["Canal Stairs", "Land_Canal_Wall_Stairs_F", 500, "object"],
	["Bag Fence (Corner)", "Land_BagFence_Corner_F", 2000, "object"],
	["Bag Fence (End)", "Land_BagFence_End_F", 2000, "object"],
	["Bag Fence (Long)", "Land_BagFence_Long_F", 2000, "object"],
	["Bag Fence (Round)", "Land_BagFence_Round_F", 2000, "object"],
	["Bag Fence (Short)", "Land_BagFence_Short_F", 2000, "object"],
	["Bag Bunker (Small)", "Land_BagBunker_Small_F", 5000, "object"],
	["Bag Bunker (Large)", "Land_BagBunker_Large_F", 5000, "object"],
	["Bag Bunker Tower", "Land_BagBunker_Tower_F", 1000, "object"],
	["Military Cargo Post", "Land_Cargo_Patrol_V1_F", 10000, "object"],
